          ...
          <div className="postcard-row">
            <div className="white-bg">
              <form className="form white-bg" id="form" action="https://submit-form.com/G6AXDTY6foZrW1yQ3HdYR" target="_self" >
                ...
                <input type="hidden" name="subject" value="Riviera - French - Concierge" />
                <fieldset>
                  <legend className="orange-500-cl">NOUS CONTACTER</legend>
                  <p className="font-m gray-500-cl">Veuillez soumettre vos coordonnées ci-dessous et l'un de nos experts Lifestyle vous contactera rapidement, ou appelez nous.</p>
